...
dHinoki <- dist(bHinokiRows)
outHinoki <- hclust(dHinoki)
plot(outHinoki)

dMixed <- dist(bMixedRows)
outMixed <- hclust(dMixed)
clusterCut <- cutree(outMixed, 30)
plot(clusterCut)

bColumnsDist <- dist(bColumns)
outbColumns <- hclust(bColumnsDist)
clusterCut <- cutree(outbColumns, 30)
